...
#this function calculates the maximum tensile and compressive stresses
def MaxTenComp(U,t,Sig_i,Sig_m,Sig_a):
    ...
    #this function calculates the maximum compressive stress for a given stress function on a given subdomain
    ...
    #this function calculates the maximum tensile stress for a given stress function on a given subdomain    
    ...
    #sending stress functions to calculate their maximum compressive and tensile stresses
