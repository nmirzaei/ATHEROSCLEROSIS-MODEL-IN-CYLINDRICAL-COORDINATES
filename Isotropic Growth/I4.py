...
k=0
ID=0
vtkfile1 = File('local location/I4_i.pvd')
vtkfile2 = File('local location/I4_m.pvd')
vtkfile3 = File('local location/I4_a.pvd')
######################################################################
...
while counter<=M:
 ...
 if counter%Skip==0:
    ...
    if counter!=0:
        #calculate the isotropic parameter
 ...
 #Create the isotropic growth tensor
