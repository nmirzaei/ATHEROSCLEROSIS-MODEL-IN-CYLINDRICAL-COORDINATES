...
while counter<=M:
 ...
 if counter%Skip==0:
    ...
    if counter!=0:
        #Creating the isotropic growth parameter
...
#Calculating the energy
    en = 2*pi*(psi_i*radius*dx(7)+psi_m*radius*dx(8)+psi_a*radius*dx(9))#+(sigma/3)*dot(deformed_N,u)*radius*ds(1))
...
#Exporting the energy via a csv file
import csv
