...
k=0
ID=0
Angles_i = File('Local Drive/Z_Growth/Angles_i.pvd')
Angles_m = File('Local Drive/Z_Growth/Angles_m.pvd')
Angles_a = File('Local Drive/Z_Growth/Angles_a.pvd')
######################################################################
...
while counter<=M:
 ...
 if counter%Skip==0:
    u = Function(V,'Local Drive/Z_Growth/displacement/u%d.xml' %(counter))
    j+=1
 ######################################################################
