...
//+
//Point(1) = {0.114, 0, 0, 1.0};
//+
//Point(2) = {0.114, 8, 0, 1.0};
//+
//Point(3) = {0.155, 0, 0, 1.0};
//+
//Point(4) = {0.155, 8, 0, 1.0};
//+
//Point(5) = {0.198, 0, 0, 1.0};
//+
//Point(6) = {0.198, 8, 0, 1.0};
//+
//Point(7) = {0.24, 0, 0, 1.0};
//+
//Point(8) = {0.24, 8, 0, 1.0};
//+
...
Field[1] = MathEval;
//+
Field[1].F = "0.021*exp(-0.238095238*abs(y-1.68))";
//+
