...
k=0
ID=0
Angles_i = File('Local drive/Theta_Growth/Angles_i.pvd')
Angles_m = File('Local drive/Theta_Growth/Angles_m.pvd')
Angles_a = File('Local drive/Theta_Growth/Angles_a.pvd')
######################################################################
